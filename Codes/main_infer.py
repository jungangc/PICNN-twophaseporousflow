...
Nx= 64
Ny =64
BHPmat = scio.loadmat('BHP_full_test.mat')
BHP_vec = torch.tensor(BHPmat['BHP_full_test'], dtype=torch.float32).cuda() 

# print(BHP_vec)
# Rate  = np.array([[100]]) # [STB/day]
# Rate_vec =      torch.tensor(Rate, dtype=torch.float32).repeat(1,300).cuda()
Rate = scio.loadmat('Qinj_full_test.mat')
Rate_vec = torch.tensor(Rate['Qinj_full_test'], dtype=torch.float32).cuda() 
# print(Rate_vec)
...
#     data_dir = '/content/PhyCRNet-main-1phaseflow/Datasets/data/2dBurgers/burgers_1501x2x128x128.mat'    
    data_dir_p = '/scratch/user/jungangc/PICNN-2phase/PICNN-2phaseflow-constBHP-64by64-heter-TransferLearning-50stepsby2-final/Datasets/data/twophaseflow/pressure_201x1x64x64_test.mat'  
    data_dir_sw = '/scratch/user/jungangc/PICNN-2phase/PICNN-2phaseflow-constBHP-64by64-heter-TransferLearning-50stepsby2-final/Datasets/data/twophaseflow/saturation_201x1x64x64_test.mat' 
...
# #     T =
    ...
    np.save('/scratch/user/jungangc/PICNN-2phase/PICNN-2phaseflow-constBHP-64by64-heter-TransferLearning-50stepsby2-final/Codes/model_infer/train_loss', train_loss)  
